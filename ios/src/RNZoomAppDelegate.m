...
@implementation RNZoomAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Phunv: Tam thoi tat man hinh cua Sample thay bang DemoController
    if ([[RNMeetingCenter shared] isEnableRNMeetingView]) {
        DemoViewController *demoVC = [[DemoViewController new] autorelease];
        UINavigationController *navVC = [[[UINavigationController alloc] initWithRootViewController:demoVC] autorelease];
